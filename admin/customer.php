...
<!--inner block start here-->
  ...
  $table = $conn->query("SELECT u.UserID, u.Username, u.Password, u.Role, u.UserStatus, u.DateAdded, u.UserDelete,
    ...
    AND u.Role='User' AND u.UserDelete=0
...
<?php
  if($table->num_rows > 0) {
    ...
    while($obj = $table->fetch_assoc()) {
      ...
      echo '<td>'; 
     echo '<a href="customer_detail.php?userid=' .$obj['UserID']. '">';
     echo $obj['Fullname'];
     echo '</a>';
     ...
     echo '<td>';
      ...
      echo '<td>';
       ...
       if ($obj['UserStatus'] == 'Active') {
            echo '<a href="status_customer.php?userid=' .$obj['UserID']. ' &userstatus=' .$obj['UserStatus']. '">
       ...
       echo '<a href="customer_transaction.php?userid=' .$obj['UserID']. '">
          <img src="icons/sales.png" style="width: 20px; height: 20px;" title="View Transactions" />
          </a>';

          

       echo '<a href="delete_customer.php?userid=' .$obj['UserID']. '&fullname=' .$obj['Fullname']. '" onclick="return confirmRemove()"><img src="icons/delete.png" style="width: 25px; height: 25px;" title="Delete user" /></a>';
...
function confirmRemove() {
  return confirm("Are you sure you want to remove this customer account?"); 
}
</script>
