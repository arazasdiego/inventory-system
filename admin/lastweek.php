...
<!--inner block start here-->
  ...
  $row2 = $sql2->fetch_assoc();
	...
	$table = $conn->query("SELECT o.OrdersID, o.ProductID, p.ProdName, p.ProdImage, p.CategoryID, c.CategoryName, ot.DateOrdered, SUM(o.TotalPrice) AS Sales 
    FROM orders AS o
    ...
    AND o.PaymentStatus='Paid' AND ot.DateOrdered BETWEEN '$lastweek' AND '$da'
...
<div class="blank">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="productsalesreport.php">Product Sales</a></li>
