...
<!--inner block start here-->
	<?php
	  $table = $conn->query("SELECT ro2.OrdersID, ro2.DateAdded, 
    bd.CustomerName
...
<?php
  if($table->num_rows > 0) {
    echo '
 <table class="table" id="dataTables-example" style="font-size: 16px; width: 100%;">
    <thead>
    <tr class="success">
      <th>OrdID</th>
      <th>Customer</th>
    ...
    while($obj = $table->fetch_assoc()) {
      ...
      echo '<b><a href="returnedorders_view.php?ordersid=' .$obj['OrdersID']. '">VIEW</a></b>';
    ...
    echo 'No records of returned orders.';
  }
  ?>
</div>
