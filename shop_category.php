...
$table = $conn->query("SELECT * FROM product WHERE ProdStatus='Active' AND Stock > 0 AND CategoryID='$categoryid'");

$current_url = urlencode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);

$category = $conn->query("SELECT * FROM category WHERE CategoryDelete=0");

$prod = $conn->query("SELECT * FROM product WHERE ProdStatus='Active' AND Stock > 0");
$count = $prod->num_rows;

$sql3 = $conn->query("SELECT * FROM category WHERE CategoryID='$categoryid'");
 ...
 _________________________________________________________ -->
    ...
    ?>
                ...
                <div class="col-md-9">
                    ...
                    '
                    <div class="box">
                        <h4>Category: ' .$row3['CategoryName']. '</h4>
   ...
   <form method="post" action="cart_update.php">    
    ...
    <div class="product">
        ...
        <div class="text">
        <h3><a href="#product_detail' .$obj['ProductID']. '" role="button" data-target = "#product_detail' .$obj['ProductID']. '" data-toggle="modal">' .$obj['ProdName']. '</a></h3>
